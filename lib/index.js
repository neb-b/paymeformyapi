...
var PayMeForMyAPI = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, { success: false, api_token: apiToken, invoice: invoice.payment_request }];
                    case 3:
                        e_1 = _a.sent();
    ...
    PayMeForMyAPI.prototype.deductBalance = function (api_token) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _c, userAdminKey, userInvoiceKey, paymentHash, data, invoice, e_2, error, errorResponseDetail;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, lnBits.checkPaymentHash({
                                url: this.config.lnBitsURL,
                    ...
                    case 2:
                        ...
                        if (!data.paid) {
                            ...
                            return [2 /*return*/, { success: false, api_token: api_token, invoice: data.details.bolt11 }];
                        }
                        return [4 /*yield*/, lnBits.createInvoice({
                                url: this.config.lnBitsURL,
                    ...
                    case 5:
                        ...
                        if (errorResponseDetail.includes('Insufficient balance')) {
                            console.log('error generating refill invoice', e_2);
                            return [2 /*return*/, this.generateApiToken()];
                        }
                        return [3 /*break*/, 6];
                    case 6: 
